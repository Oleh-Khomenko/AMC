...
CREATE TABLE `commit` (
  ...
  KEY `fk_Commit_Branch1_idx` (`Branch_name`),
  CONSTRAINT `fk_Commit_Branch1` FOREIGN KEY (`Branch_name`) REFERENCES `branch` (`name`)
...
INSERT INTO `commit` VALUES (1,'corpus1','2010-11-20 20:00:00','teamlead');
