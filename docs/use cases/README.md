...
НАЗВА: Виконання аналізу тексту

УЧАСНИКИ: Редактор, система

ПЕРЕДУМОВИ: Наявність даних

РЕЗУЛЬТАТ: Текст, у якому виділені ключові слова

ВИКЛЮЧНІ СИТУАЦІЇ:

EX.6 Неправильно виконаний аналіз
...
НАЗВА: Результат роботи передається менеджеру
...
РЕЗУЛЬТАТ: Проаналізований текст
