...
Гість має можливість зарєєструватися, відправити запит на обробку та подивитися інформацію щодо авторів проекту та його документації. А зарєєстрований користувач має можливість авторизуватися, змінити налаштування, подивитися історію запитів та проаналізувати власний текст. 
