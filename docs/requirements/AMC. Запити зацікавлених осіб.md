...
Користувачі можуть бути зареєстрованими і незареєстрованими(гості). Відповідно до цього поділяється функціонал.

 Гість має можливість:
- зарєєструватися
- відправити запит на обробку
- подивитися інформацію щодо авторів проекту та його документації
- може подивитись головну інформацію про серсіс

Зарєєстрований користувач має можливість:
- авторизуватися
- змінити налаштування
- змінити персональну інформацію
- подивитися історію запитів
- проаналізувати власний текст
